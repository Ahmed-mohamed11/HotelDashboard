...
import { FaHandshake, FaBell, FaFileExport } from "react-icons/fa";
...
const Main = ({ role }) => {
  ...
  const series = [
    { name: "New Visitors", data: [30, 40, 35, 50, 49, 60, 70, 91, 125, 145, 160, 175] },
    { name: "Returning Visitors", data: [20, 30, 25, 40, 45, 50, 55, 65, 80, 95, 105, 115] },
    { name: "Referrals", data: [10, 20, 15, 30, 35, 40, 50, 55, 65, 75, 85, 95] },
  ];
  ...
  const donutChartOptions = {
    ...
    title: { text: "Countries with Bookings", align: "center" },
  ...
  const groupedBarChartSeries = [
    { name: "Demand Volume", data: [30, 50, 45, 60] },
    { name: "Service", data: [20, 40, 35, 50] },
  ];
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      const ctx = gsap.context(() => {
        gsap.timeline()
           .from(".card1", { opacity: 0, y: 50, duration: 1, stagger: 0.2 }, "-=0.5")
       });
